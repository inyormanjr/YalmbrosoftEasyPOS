...
@Component({
  selector: 'app-manage-gender-modal',
  templateUrl: './manage-gender-modal.component.html',
  styleUrls: ['./manage-gender-modal.component.css'],
})
export class ManageGenderModalComponent implements OnInit {
  userForm: FormGroup;
  constructor(
